...
const SignUp = () => (
  <section className="bg-sticky-background-login bg-cover bg-center">
    <div className="h-screen flex justify-center items-center">
      <form className="w-96 h-96 flex flex-col justify-evenly items-center border border-purple-800 rounded-md">
        <p className="text-2xl">Sign Up</p>
        <input className="w-80 p-2.5 border border-purple-800 rounded-md" type="email" placeholder="Email" />
        <input className="w-80 p-2.5 border border-purple-800 rounded-md" type="email" placeholder="Confirm your email" />
        <input className="w-80 p-2.5 border border-purple-800 rounded-md" type="password" placeholder="Password" />
        <input className="w-80 p-2.5 border border-purple-800 rounded-md" type="password" placeholder="Confirm your Password" />
